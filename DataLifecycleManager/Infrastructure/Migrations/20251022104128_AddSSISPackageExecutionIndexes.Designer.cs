...
namespace DataLifecycleManager.Infrastructure.Migrations
{
    ...
    [Migration("20251022104128_AddSSISPackageExecutionIndexes")]
    partial class AddSSISPackageExecutionIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLifecycleManager.Domain.Entities.SSISPackageExecution", b =>
                {
                    ...
                    b.HasIndex("SSISPackageId1");

                    b.HasIndex("Status", "CreatedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_SSISPackageExecutions_Status_CreatedAt");

                    b.ToTable("SSISPackageExecutions", (string)null);
                });
            ...
            modelBuilder.Entity("DataLifecycleManager.Domain.Entities.SSISPackageExecution", b =>
                {
                    ...
                    b.HasOne("DataLifecycleManager.Domain.Entities.SSISPackage", null)
                        .WithMany("Executions")
                        .HasForeignKey("SSISPackageId1");
